  ...
  <div class="content">
    ...
    <b-input-group>
      <b-input-group-prepend>
        <b-button variant="outline-info" @click.prevent="handleRefresh">Refresh</b-button>
      </b-input-group-prepend>
      <b-form-input placeholder="Search Agent name" v-model="type"></b-form-input>
      <b-input-group-append>
        <b-button variant="info" @click.prevent="handleSearchAgent">Search</b-button>
      </b-input-group-append>
    </b-input-group>

    <div class="striped-table" id="overscroll">
      <table>
        <thead>
          <tr>
            <th>NAME</th>
        ...
        <tbody>
          <tr v-for="agent in agents" :key="agent.id">
            ...
            <td v-if="editing === agent.agent_id">
              <input
                type="text"
                v-model="updatedAgent.latitude"
                @focus="clearStatus"
                :class="{ 'has-error': submitting && invalidLatitude }"
              />
            ...
            <td v-if="editing === agent.agent_id">
              <input
                type="text"
                v-model="updatedAgent.longitude"
                @focus="clearStatus"
                :class="{ 'has-error': submitting && invalidLatitude }"
              />
            ...
            <div>
              <td v-if="editing === agent.agent_id">
                <b-button
                  @click.prevent="handleUpdate(agent.agent_id)"
                  b-button
                  variant="secondary"
                >Save</b-button>
              </td>
              ...
              <td>
                <b-button
                  variant="danger"
                  @click.prevent="handleDelete(agent.agent_id)"
                  v-if="showing"
                >Delete</b-button>
              </td>
            </div>
...
export default {
  ...
  methods: {
    ...
    cancelable() {
      (this.editing = null), (this.showing = true);
    },
    editingAgent(agent) {
      if (
        agent.name === "" ||
    ...
    handleSearchAgent() {
      let apiUrl = `/api/v1/shipment/agent?page=1&per_page=100&name=${this.type}`;
      let token =
        "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE4ODE1NzUzMTQsImlhdCI6MTU2NjIxNTMxNCwiYWNjb3VudF9pZCI6Mywicm9sZV9pZCI6IkFETUlOIiwidXNlcm5hbWUiOiJhZG1pbi1kZWZhdWx0In0.g-DcUvVftYV87T_Ecx2RBEhbIzWtFH7KX8JNENZVAbDqgPm6I54Kh_RYC5fqreCM8SP1cQAj7ZP1VHXB3fo2PXaxImkCE6ADchcIDtCETiqzyhaU8wau6v8HXjqb3VuNXNlhSyQcQMZfwSLC16uQfojy28_lbvGYBoSJpcBQ6AALDan6zJTwkPg2JpmC26irxykTfUX5fAwAkyZNa8wvfipEFE0KP72J4mTSpsmmovxsiE9662dRsb3rei-WmycAeMEfVJUwEyHoibn8IHmWpjvvMKrcA0hd5Nt8i_alHc4PAy3yEJ_--Za2vK3bg-0drpAdEc9DDEQdZKyko6pkeA";
      axios
        .get(apiUrl, { headers: { Authorization: `${token}` } })
    ...
    handleUpdate(id) {
      ...
      let token =
        "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE4ODE1NzUzMTQsImlhdCI6MTU2NjIxNTMxNCwiYWNjb3VudF9pZCI6Mywicm9sZV9pZCI6IkFETUlOIiwidXNlcm5hbWUiOiJhZG1pbi1kZWZhdWx0In0.g-DcUvVftYV87T_Ecx2RBEhbIzWtFH7KX8JNENZVAbDqgPm6I54Kh_RYC5fqreCM8SP1cQAj7ZP1VHXB3fo2PXaxImkCE6ADchcIDtCETiqzyhaU8wau6v8HXjqb3VuNXNlhSyQcQMZfwSLC16uQfojy28_lbvGYBoSJpcBQ6AALDan6zJTwkPg2JpmC26irxykTfUX5fAwAkyZNa8wvfipEFE0KP72J4mTSpsmmovxsiE9662dRsb3rei-WmycAeMEfVJUwEyHoibn8IHmWpjvvMKrcA0hd5Nt8i_alHc4PAy3yEJ_--Za2vK3bg-0drpAdEc9DDEQdZKyko6pkeA";
      axios
        .post(`/api/v1/shipment/agent/${id}`, data, {
          headers: {
            Authorization: `${token}`,
    ...
    handleDelete(id) {
      let token =
        "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE4ODE1NzUzMTQsImlhdCI6MTU2NjIxNTMxNCwiYWNjb3VudF9pZCI6Mywicm9sZV9pZCI6IkFETUlOIiwidXNlcm5hbWUiOiJhZG1pbi1kZWZhdWx0In0.g-DcUvVftYV87T_Ecx2RBEhbIzWtFH7KX8JNENZVAbDqgPm6I54Kh_RYC5fqreCM8SP1cQAj7ZP1VHXB3fo2PXaxImkCE6ADchcIDtCETiqzyhaU8wau6v8HXjqb3VuNXNlhSyQcQMZfwSLC16uQfojy28_lbvGYBoSJpcBQ6AALDan6zJTwkPg2JpmC26irxykTfUX5fAwAkyZNa8wvfipEFE0KP72J4mTSpsmmovxsiE9662dRsb3rei-WmycAeMEfVJUwEyHoibn8IHmWpjvvMKrcA0hd5Nt8i_alHc4PAy3yEJ_--Za2vK3bg-0drpAdEc9DDEQdZKyko6pkeA";
      axios
        .delete(`api/v1/shipment/agent/${id}`, {
