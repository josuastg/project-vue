          ...
          <div>
            <b-form @submit.stop.prevent="handleSubmit">
              ...
              <b-form-invalid-feedback
                :state="validationName"
              >Your user ID must be more than 8 characters long.</b-form-invalid-feedback>
              <b-form-valid-feedback :state="validationName">Looks Good.</b-form-valid-feedback>
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      axios
        .post("/api/v1/shipment/agent", data, {
          headers: {
            Authorization: `${token}`,
  ...
  computed: {
    validationName() {
      if (this.agent.name === "") {
        return null;
      } else return this.agent.name.length > 8;
    }
  }
};
</script>
